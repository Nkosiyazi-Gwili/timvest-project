      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/30 shadow-2xl">
            ...
            />
            <div className="mt-2 text-white font-bold text-lg leading-tight text-center">
              <div className="text-primary-100">in partnership with</div>
              <div className="text-xl text-white font-bold mt-1">TIMVEST</div>
            </div>
          </div>
        </div>
